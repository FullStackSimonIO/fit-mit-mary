          ...
          <div className="flex flex-col lg:items-center lg:flex-row gap-y-8 sm:gap-y-12 lg:gap-x-16 xl:gap-x-24">
            ...
            <div className="w-full space-y-6 lg:max-w-lg shrink-0 xl:max-w-2xl">
              ...
              <a
                href="#"
                title=""
                className="text-white bg-red-700 justify-center hover:bg-primary-800 inline-flex items-center  focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center "
                role="button"
              >
                JETZT ANFRAGEN
                <svg
