<div className="space-y-4">
  <span className="bg-primary-buttonGreen text-primary-backgroundGreen text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded ">
    Kurse
  </span>
  <h3 className="text-2xl font-bold leading-tight text-primary-buttonGreen">
    Yogakurse
  </h3>
  <p className="text-lg font-normal text-primary-paragraph">
    Ich biete folgende Kurse an:
    <ul className="flex flex-col justify-center">
      <li>Anfänger</li>
      <li>Fortgeschrittene</li>
      <li>Private Stunden</li>
    </ul>
  </p>
  <a
    href="#"
